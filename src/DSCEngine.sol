 ...
 *
 * The system is designed to be as minimal as possible, and have tokens maintain a 1
 * token == 1 peg
 * This stablecoin has the propertiess:
...
contract DSCEngine is ReentrancyGuard {
    ...
    using OracleLib for AggregatorV3Interface;S
     ...
     * @param tokenCollateralAddress The address of Token to deposit as collaterala
     ...
     * Thiis function burns DSC and redeems underlying collateral in one transaction
     */
     ...
     * You can partially liquidate user
     * You will get liquidation bonus for taking users fund
